...
H029a = dam_area.MustBeInProximity(watercourse_area_or_standing_water, distance=proximity_distance)
H029b = dam_line.MustBeInProximity(watercourse_area_or_standing_water, distance=proximity_distance)
H029c = dam_point.MustBeInProximity(watercourse_area_or_standing_water, distance=proximity_distance)
